<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        table = $('#data').DataTable({
            ...
            // ],
            "ajax": {
                "url": "<?php echo site_url('manajemen/kesatuan/getAllData') ?>",
                "type": "POST",
                "data": {
                    ...
                    <div class="col-md-12">
                        <div class="field item form-group">
                            ...
                            <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
                                <input type="text" name="nama_kesatuan" id="nama_kesatuan" class="form-control has-feedback-left">
